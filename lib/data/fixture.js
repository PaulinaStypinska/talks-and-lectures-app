...
var connectionString = 'postgres://localhost:5432/talks';    pg.connect(connectionString, function (err, client) {
        if (err) throw err;
        async.series([
            function(callback) {
...
function createTags(client, tags, callback) {
    async.each(tags, function(tag, callback) {
        client.query('insert into tag(eventbrite) values($1)', [tag.genre], function(err, result) { //to change to reference the deeper json structure
            callback(err, result);
