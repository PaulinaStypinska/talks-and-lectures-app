...
//methods
var eventbriteParam1 = '&expand=category,format,venue&venue.city=london&venue.country=GB&formats=2';
...
function makeEventbriteRequest (initalUri, method, params, key){
...
makeEventbriteRequest(eventbriteIntial,eventbriteEventsMethod, eventbriteParam1,eventbriteKey);
